...
planet1 = vp.sphere(pos=vp.vector(0, 0, 0), radius=0.5, color=vp.color.green, mass=1000, momentum=vp.vector(0, 0, 0), make_trail=True)

planet2 = vp.sphere(pos=vp.vector(10, 0, 0), radius=0.2, color=vp.color.red, mass=100, momentum=vp.vector(0, V, 0), make_trail=True)

planet3 = vp.sphere(pos=vp.vector(9.5, 0, 0), radius=0.1, color=vp.color.blue, mass=1, momentum=vp.vector(0, -V / 200, 0), make_trail=True)
