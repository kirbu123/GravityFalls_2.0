...
planet1 = vp.sphere(pos=vp.vector(-1, 0, 0), radius=0.1, color=vp.color.green, mass=100, momentum=vp.vector(0, V, 0), make_trail=True)

planet2 = vp.sphere(pos=vp.vector(1, 0, 0), radius=0.1, color=vp.color.red, mass=100, momentum=vp.vector(0, -V, 0), make_trail=True)

planet3 = vp.sphere(pos=vp.vector(0, 0, 0), radius=0.05, color=vp.color.blue, mass=1, momentum=vp.vector(0, 0, V / 70), make_trail=True)
