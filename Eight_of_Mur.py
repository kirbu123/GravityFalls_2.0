...
planet1 = vp.sphere(pos=vp.vector(-1, 0, 0), radius=0.05, color=vp.color.green, mass=100, momentum=vp.vector(V1, V2, 0), make_trail=True)

planet2 = vp.sphere(pos=vp.vector(1, 0, 0), radius=0.05, color=vp.color.red, mass=100, momentum=vp.vector(V1, V2, 0), make_trail=True)

planet3 = vp.sphere(pos=vp.vector(0, 0, 0), radius=0.05, color=vp.color.blue, mass=100, momentum=vp.vector(-2 * V1, -2 * V2, 0), make_trail=True)
